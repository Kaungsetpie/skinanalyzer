"""
Train MobileNetV2 skin-type classifier (oily / normal / dry) with standard MobileNetV2 preprocessing.

Usage:
  python train_skin_type_model.py --data-dir data/skin_type_preprocessed

Saves:
  models/skin_type_model.keras
...
def load_paths_and_labels(data_dir: str):
    ...
    print(f"\n[1/3] Dataset summary:")
    for cls in CLASSES:
        print(f"  • {cls:8s}: {labels.count(cls)} images")
...
def train(data_dir: str) -> None:
    ...
    print("\n" + "="*60)
    print(" 🎯 FINAL SKIN TYPE MODEL VALIDATION REPORT")
    print("="*60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train MobileNetV2 skin-type classifier')
    parser.add_argument('--data-dir', default='data/skin_type_preprocessed')
